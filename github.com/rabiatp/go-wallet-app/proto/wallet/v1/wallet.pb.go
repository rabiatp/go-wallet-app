...
type ListTransactionsResponse struct {
	...
	Type          string                 `protobuf:"bytes,2,opt,name=type,proto3" json:"type,omitempty"`                            // "deposit" / "withdraw"
	Amount        string                 `protobuf:"bytes,3,opt,name=amount,proto3" json:"amount,omitempty"`                        // decimal string
	CreatedAt     string                 `protobuf:"bytes,4,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"` // RFC3339 timestamp string
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListTransactionsResponse) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *ListTransactionsResponse) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *ListTransactionsResponse) GetAmount() string {
	if x != nil {
		return x.Amount
	}
	return ""
...
func (x *ListTransactionsResponse) GetCreatedAt() string {
	if x != nil {
		return x.CreatedAt
	}
	return ""
...
const file_wallet_v1_wallet_proto_rawDesc = "" +
	...
	"\x10ListTransactions\x12\".wallet.v1.ListTransactionsRequest\x1a#.wallet.v1.ListTransactionsResponseB;Z9github.com/rabiatp/go-wallet-app/proto/wallet/v1;walletv1b\x06proto3"
...
var file_wallet_v1_wallet_proto_goTypes = []any{
	...
	(*ListTransactionsResponse)(nil), // 7: wallet.v1.ListTransactionsResponse
}
var file_wallet_v1_wallet_proto_depIdxs = []int32{
	0, // 0: wallet.v1.Wallet.GetBalance:input_type -> wallet.v1.GetBalanceRequest
	2, // 1: wallet.v1.Wallet.Deposit:input_type -> wallet.v1.DepositRequest
	4, // 2: wallet.v1.Wallet.Withdraw:input_type -> wallet.v1.WithdrawRequest
	6, // 3: wallet.v1.Wallet.ListTransactions:input_type -> wallet.v1.ListTransactionsRequest
	1, // 4: wallet.v1.Wallet.GetBalance:output_type -> wallet.v1.GetBalanceResponse
	3, // 5: wallet.v1.Wallet.Deposit:output_type -> wallet.v1.DepositResponse
	5, // 6: wallet.v1.Wallet.Withdraw:output_type -> wallet.v1.WithdrawResponse
	7, // 7: wallet.v1.Wallet.ListTransactions:output_type -> wallet.v1.ListTransactionsResponse
